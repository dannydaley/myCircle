    ...
    render() {
       ...
       if (!dataIsLoaded) {
            ...
            return(
                ...
                {this.state.friends.sort((a, b) => a.firstName.localeCompare(b.firstName)).map(friend => (
                  friend.username !== loggedInUsername ?  
                    <Button                        
                        ...
                        >
                            ...
                            <Button variant="contained" onClick={() => this.deleteFriend(friend.username)}>Delete</Button>
                    </Button>    
                  : ''))}
              </Stack>
                </div>
