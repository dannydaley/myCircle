...
export default class PostActions extends React.Component {
    ...
    applyVote =  () => { 
        ...
        fetch('http://localhost:3001/votePost', {
          method: 'post',
    ...
    render() {
        ...
        return (
            <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-around',marginBottom: '0px', marginBottom: '10px', width: '100%'}}>
                ...
                <div style={{width: '40vw', height: '30px' ,display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: '20px'}}>
                    <AddCommentIcon style={{marginRight: '10px', color: 'white'}}/>
                    <p style={{color: '#217cd8', fontWeight: 'bold'}}>123</p>
                </div>
            </div>
        )
    }
